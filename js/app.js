...
gangsta.decode_tx = function(rawtx, cb, eb) {
    console.log(rawtx)
    //todo: js decoder
    $.ajax({type: 'POST', url: 'http://gangsta.dassori.me/decodeTx/', data: {"rawtx": rawtx}}).success(function(res) {
        console.log(res)
        if (res['status'] == 'success') {
            cb(res)
        } else {
...
gangsta.push_tx = function(rawtx, cb, eb) {
    console.log(rawtx)
    $.ajax({type: 'POST', url: 'http://gangsta.dassori.me/pushTx/', data: {"rawtx": rawtx}}).success(function(res) {
        console.log(res)
        if (res['status'] == 'success') {
            cb(res['txid'])
        } else {
